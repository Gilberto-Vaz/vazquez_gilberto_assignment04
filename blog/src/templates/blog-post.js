...
const BlogPost = (props) => {
    ...
    return (
        <Layout>
            <div>
    <h2>{props.data.contentfulLife.title}</h2>
    <p style={{fontWeight: 200, fontSize: "0.8rem"}}>Published {props.data.contentfulLife.publishedDate}</p>
    <p style={{fontWeight: 300, fontSize: "0.9rem"}}>Written By {props.data.contentfulLife.author}</p>
    {
        documentToReactComponents(props.data.contentfulLife.body.json,options)
    }
